...
#  * @create date 2022-03-10 09:07:17
#  * @modify date 2022-03-10 09:07:17
#  * @desc [description]
#  */
...
However field_name, month and day  are not used in FMTSTR on the SDS client instance.
...
OWN_FMTSTR = os.path.join("{field_name}","seedfiles",
    "{year}-{month:02d}", "{year}-{month:02d}-{day:02d}", 
    "{network}.{station}.{location}.{channel}.{year}.{doy:03d}")

class OwnClient(Client):
    FMTSTR = OWN_FMTSTR

    def __init__(self,root_path,field_name,**kwargs):
